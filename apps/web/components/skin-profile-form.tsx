...
import { SkincareRoutineChatbot } from "@/components/skincare-routine-chatbot"
...
export function SkinProfileForm({ onComplete, onCancel }: SkinProfileFormProps) {
  ...
  const [chatbotRoutine, setChatbotRoutine] = useState("")
      ...
      <Card>
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {/* Skincare Routine Chatbot */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold">Describe Your Current Routine</h3>
              <p className="text-sm text-muted-foreground">
                Use our AI chatbot to describe your current skincare routine in detail. 
                This helps us provide more personalized recommendations.
              </p>
              <SkincareRoutineChatbot 
                onRoutineExtracted={setChatbotRoutine}
                initialRoutine={chatbotRoutine}
              />
            </div>
