...
class AIRecommendationEngine:
    ...
    async def get_ai_recommendations(
        ...
        try:
            ...
            cached_recommendations = await self.caching.get_recommendation_cache(
                skin_analysis.get("detected_conditions", []),
                user_profile
            )
    ...
    async def _generate_fresh_recommendations(
        ...
        try:
            ...
            google_products = await self._get_google_recommendations(
    ...
    async def _get_vertex_ai_recommendations(
        ...
        try:
            ...
            result = await self.vertex_ai.get_ai_recommendations(
                skin_analysis, user_profile
            )
    ...
    async def _apply_diversity_filtering(
        ...
        try:
            ...
            max_per_type = max(1, max_recommendations // len(product_types)) if product_types else max_recommendations
