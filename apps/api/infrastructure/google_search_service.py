        ...
        try:
            ...
            return {
                ...
                "metadata": {
                    ...
                    "total_available": results.get("searchInformation", {}).get(
                        "totalResults", "0"
                    ),
                },
            }
            ...
            return {"success": False, "error": f"Search API error: {str(e)}", "products": []}
        except Exception as e:
            logger.error(f"Unexpected error during product search: {str(e)}")
            return {"success": False, "error": f"Search failed: {str(e)}", "products": []}
